...
module.exports = {
    scripts: {
        ...
        'publish/major': {
            ...
            script: series(`nps validate`, `npm version major`, `nps publish/gh-pages`),
        },
        'publish/minor': {
            description: `Publish a new minor version.`,
            script: series(`nps validate`, `npm version minor`, `nps publish/gh-pages`),
        },
        'publish/patch': {
            description: `Publish a new patch version.`,
            script: series(`nps validate`, `npm version patch`, `nps publish/gh-pages`),
        },
        'publish/gh-pages': {
            hiddenFromHelp,
            script: series(`nps clean`, `nps build`, `gh-pages --version --dir public --silent --no-push`, `nps clean/public`),
        },
        validate: {
